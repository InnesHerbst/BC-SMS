...
public abstract class Person {
    ...
    public Person(int p_ID, String p_initials, String p_firstname, String p_lastname, Date p_dob, int p_gender, int p_phone, String p_email, String p_password, String p_address1, String p_address2) {
        this.p_ID = p_ID;
